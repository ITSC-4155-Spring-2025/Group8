...
import NavbarUser from "../components/Navbar_User"; // Ensure this is correct
...
function Learning() {
  ...
  // Hardcoded topics with passages, key takeaways, and quiz
  const topics = [
    {
      topic: "Budgeting",
      passage: `
    ...
    },
    {
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "B) A rate at which you are taxed based on income", correct: true },
...
To invest successfully in the stock market, it’s important to understand stock valuation—the process of determining a stock's worth based on factors like earnings, revenue growth, and market conditions. Investors often analyze financial statements, track company news, and monitor market trends to make informed decisions. While the stock market can be volatile in the short term, it historically provides solid returns over the long term. Long-term investing and diversification are often recommended strategies for managing risk and optimizing returns.
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "C) Stocks are guaranteed to increase in value", correct: false }
        ]
      }
    },
    {
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "B) Paying off the highest-interest debt first", correct: false },
          { answer: "C) Consolidating all debts into one payment", correct: false }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "B) A tax-advantaged savings plan for education", correct: true },
          { answer: "C) A credit card", correct: false }
        ]
      }
    },
...
Additionally, there are other types of insurance that cater to specific needs, such as disability insurance, which provides income in the event of a temporary or permanent disability, or renters insurance, which protects renters against property loss or damage. Business owners can also benefit from various types of insurance, like liability insurance, which protects against legal claims for accidents or negligence. Understanding the different types of coverage available and the details of each policy will help you make informed decisions about your insurance needs.
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "B) Financial support to beneficiaries after death", correct: true },
    ...
    },
    {
      ...
      quiz: {
        ...
        options: [
          ...
          { answer: "B) Decreases the purchasing power of money", correct: true },
    ...
    },
    {
      ...
      quiz: {
        ...
        options: [
          { answer: "A) By setting fixed interest rates for all loans", correct: false },
          { answer: "B) By adjusting rates to manage economic activity", correct: true },
          { answer: "C) By determining interest rates based on inflation rates", correct: false }
        ]
      }
    },
    {
      ...
      quiz: {
        question: "What is the main difference between a checking and a savings account?",
        options: [
          { answer: "A) Checking accounts offer higher interest rates", correct: false },
          { answer: "B) Savings accounts are designed for long-term saving and earn interest", correct: true },
          { answer: "C) Checking accounts are only available for a limited time", correct: false }
        ]
      }
    }
  ];
  ...
  const goToNextTopic = () => {
    const nextTopicIndex = (currentTopicIndex + 1) % topics.length; // Cycle back to the first topic
    setCurrentTopicIndex(nextTopicIndex);
    setQuizFeedback(""); // Reset feedback when a new topic is generated
  };

  // Handle quiz submission
  const handleQuizSubmit = (answer) => {
    const correctAnswer = topics[currentTopicIndex].quiz.options.find(option => option.correct);
    setQuizFeedback(
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#d1fae5,_#ffffff_60%,_#d1fae5)] text-gray-900">
      <NavbarUser /> {/* Make sure to fix the import issue */}
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6">
          <h2 className="text-2xl font-semibold">Today's Topic: {currentTopic.topic}</h2> {/* Display today's topic dynamically */}
          <p className="mt-2 text-gray-700">
            {currentTopic.passage}
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            ...
            onClick={goToNextTopic} // Move to next topic when clicked
          >
            Next Topic
          </button>
        </div>
