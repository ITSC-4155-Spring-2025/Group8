...
function Hero() {
  const [text] = useTypewriter({
    words: ["Learn Personal Finance", "Master Your Money", "Plan for a Secure Future"],
    loop: true,
    delaySpeed: 2000,
  });
    ...
    <div className="relative w-full h-screen overflow-hidden z-0">
      ...
      <div className="flex flex-col md:flex-row h-full justify-center items-center max-w-[1400px] mx-auto px-4">
        ...
        <div className="flex flex-col justify-center text-center items-center pr-10 w-10/12">
          ...
          <Link to="/login"><button className="font-sora mt-4 mx-2 px-4 py-4 bg-green-600 text-white shadow-md hover:bg-lime-400 hover:text-white transition-all duration-300 ease-in-out rounded-md inline-block w-auto max-w-fit">
            Get Learning
          </button>
          </Link>
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-full">
          ...
          <path d="M741,116.23C291,117.43,0,27.57,0,6V120H1200V6C1200,27.93,1186.4,119.83,741,116.23Z" className="fill-green-500"></path>
          </svg>
        </div>
